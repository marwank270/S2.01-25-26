...
- Noa H.-B. Z. - [Mail étudiant](mailto:noa.hoss-ben-zekri@etu.u-paris.fr)
- Rayane E. - [Mail étudiant](mailto:rayane.embarek@etu.u-paris.fr)
- Selim K. - [Mail étudiant](mailto:selim.kefi@etu.u-paris.fr)
...
1. Problème de CORS lors de l'appel à l'API pour créer une partie.
   ...
   - Tentative de contourner en utilisant un proxy, mais cela n'a pas fonctionné. (https://cors-anywhere.herokuapp.com/), instantanément bloqué par le serveur.
   ...
   > Solution: *J'ai été stupide de penser que l'erreur venait d'un refus injustifé du serveur alors que le problème était simplement du à une mauvaise définition des valeurs de la difficulté ("facile" était envoyé comme chaîne au lieu préalablement d'être converti en nombre "4").
